...
function transformSearchTicket(t) {
    return {
        ...
        orderId: t.orderId,
        createdAt: moment(t.createdAt).tz('Asia/Shanghai').format('YYYY-MM-DD HH:mm:ss'),
...
function formatTime(t) {
    ...
    var cleanDate = '<span class="form-cell-date">' + moment(t).tz('Asia/Shanghai').format('YYYY-MM-DD') + '</span> <span class="form-cell-time">' + moment(t).format('HH:mm:ss') + '</span>';
    return date;
}
...
function formatTimeLong(t) {
    ...
    var date = moment(t).tz('Asia/Shanghai').format('YYYY-MM-DD HH:mm:ss');
    return date;
}
